...
| `region` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-region/docs/implementation-plan.md` (slice #6: storefront error view-model exposes stable status codes with localized labels) |
