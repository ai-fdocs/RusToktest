...
| `inventory` | admin | `in_progress` | `in_progress` | `core_transport` | `crates/rustok-inventory/docs/implementation-plan.md` (Wave 5: admin read facade + package-private transitional commerce GraphQL adapter, compatibility test на минимальную inventory read model) |
