...
| `search` | admin + storefront | `in_progress` | `in_progress` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #32: storefront suggestions adapter renders core-owned suggestion view-models; GraphQL fallback unchanged) |
