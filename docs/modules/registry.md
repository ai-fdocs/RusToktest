...
| `search` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-search/docs/implementation-plan.md` (slice #20: render-ready view-model admin preview panel перенесён в core) |
