...
| `cart` | storefront | `in_progress` | `in_progress` | `crates/rustok-cart/docs/implementation-plan.md` (slice: storefront `core` policy helpers + thin `transport` facade introduced without dropping native/GraphQL parity) |
