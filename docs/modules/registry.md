...
| `search` | admin + storefront | `in_progress` | `not_started` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #38: admin dictionaries mutation feedback envelope is core-owned; Leptos adapter only wires labels, transport calls and reset effects; GraphQL fallback unchanged) |
