...
| `commerce` | admin + storefront | `in_progress` | `in_progress` | `core_transport` | `crates/rustok-commerce/docs/implementation-plan.md` (slice 10.5: admin/storefront core helpers + module-owned transport facades; UI adapters no longer call raw `api::*` for covered flows) |
