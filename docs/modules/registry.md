...
| `search` | admin + storefront | `in_progress` | `not_started` | `core_transport_ui` | `crates/rustok-search/docs/implementation-plan.md` (slice #39: storefront core owns search route-query intent for `q`/`preset` set/delete policy; native/GraphQL transport facade unchanged) |
