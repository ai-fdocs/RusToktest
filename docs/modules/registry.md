...
| `region` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-region/docs/implementation-plan.md` (slice #4: typed storefront transport error envelope preserves native+GraphQL fallback evidence) |
