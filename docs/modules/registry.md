...
| `commerce` | admin + storefront | `in_progress` | `in_progress` | `crates/rustok-commerce/docs/implementation-plan.md` (slice 10.1/10.3: completion возвратов публикует order-owned resolution-ссылки на refund/exchange/order-change) |
...
| `order` | admin | `in_progress` | `in_progress` | `crates/rustok-order/docs/implementation-plan.md` (slice 10.1/10.3: resolution-ссылки возврата for refund/exchange/order-change orchestration) |
