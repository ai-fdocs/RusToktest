...
Рабочий remediation backlog закрыт и удалён как временный артефакт; устойчивые контракты перенесены в
[архитектуру модулей](../architecture/modules.md) и ADR по lifecycle hook phases.
...
> Перепроверено 2026-05-18: часть пунктов уже закрыта в текущем коде.
> Статус remediation-плана закрыт; дальнейшие разборы новых ошибок ведутся отдельными планами, а устойчивые контракты зафиксированы в архитектурной документации и ADR.
