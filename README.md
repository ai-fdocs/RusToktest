...
Key references:
- [RUSTOK_MANIFEST.md](RUSTOK_MANIFEST.md) — platform manifesto
- [Architecture overview](docs/architecture/overview.md)
- [Architecture principles](docs/architecture/principles.md)
- [API boundaries (GraphQL vs REST)](docs/architecture/routing.md)
...
For a detailed breakdown of the system logic, event flow, and CQRS-lite implementation, see [Detailed Architecture Documentation](docs/architecture/overview.md).
