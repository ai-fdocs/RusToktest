...
- Current phase: ffa_admin_table_action_view_core_boundary
- Last checkpoint: FFA slice #80 completed blog admin table action presentation in Leptos-free `BlogPostAdminTableRowViewModel` by moving archive/delete labels and archive visibility into core while preserving the existing native/GraphQL transport contract.
